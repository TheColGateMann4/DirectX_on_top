...

	{
...

		{
...

			{
				...
				DynamicConstantBuffer::ImguiAdditionalInfo::ImguiFloatInfo floatPowInfo = {};
				floatPowInfo.v_min = 0.0f;
				floatPowInfo.v_max = 100.0f;
				...
				layout.Add<DynamicConstantBuffer::DataType::Float3>("subsurfaceColor", &colorInfo);
				layout.Add<DynamicConstantBuffer::DataType::Float>("subsurfaceIntensity", &floatPowInfo);
				layout.Add<DynamicConstantBuffer::DataType::Float>("scatteringRadius", &floatPowInfo);
				layout.Add<DynamicConstantBuffer::DataType::Float>("rimPower", &floatPowInfo);
				layout.Add<DynamicConstantBuffer::DataType::Float>("rimIntensity", &floatPowInfo);
				...
				*bufferData.GetElementPointerValue<DynamicConstantBuffer::DataType::Float3>("subsurfaceColor") = { 1.0f, 0.0f, 0.0f };
				*bufferData.GetElementPointerValue<DynamicConstantBuffer::DataType::Float>("subsurfaceIntensity") = 1.0f;
				*bufferData.GetElementPointerValue<DynamicConstantBuffer::DataType::Float>("scatteringRadius") = 1.0f;
				*bufferData.GetElementPointerValue<DynamicConstantBuffer::DataType::Float>("rimPower") = 1.0f;
				*bufferData.GetElementPointerValue<DynamicConstantBuffer::DataType::Float>("rimIntensity") = 1.0f;
