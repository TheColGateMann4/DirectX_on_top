...
{
public:
	DomainShader(GFX& gfx, std::string path);
	void Bind(GFX& gfx) noexcept override;

public:
	static std::shared_ptr<DomainShader> GetBindable(GFX& gfx, const std::string path)
	{
		return BindableList::GetBindable<DomainShader>(gfx, path);
	}
