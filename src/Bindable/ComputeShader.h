...
{
public:
	ComputeShader(GFX& gfx, std::string path);
	void Bind(GFX& gfx) noexcept override;

public:
	static std::shared_ptr<ComputeShader> GetBindable(GFX& gfx, const std::string path)
	{
		return BindableList::GetBindable<ComputeShader>(gfx, path);
	}
