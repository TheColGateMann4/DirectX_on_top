	...
	SceneObject({0.0f, 0.0f, 0.0f})
{
	...
	SimpleMesh skyboxModel = Cube::GetInsideDrawnMesh(scale, false);
	...
	m_pTransformConstBuffer = std::make_shared<SkyboxTransformBuffer>(gfx, *this, 0);

	{
...

		{
			...
			shadowStep.AddBindable(CubeMapTexture::GetBindable(gfx, "Images\\SpaceSkybox\\Space.png", 0));
