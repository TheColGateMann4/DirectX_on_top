...
VOID Application::DoFrame()
{
	...
	{
// 		KEYMACROAWW(b->r, KEY_A, 0.005f);
// 		KEYMACROAWW(b->r, KEY_Z, -0.005f);
// 
// 		KEYMACROAWW(b->roll, KEY_S, 0.0005f);
// 		KEYMACROAWW(b->roll, KEY_X, -0.0005f);
// 
// 		KEYMACROAWW(b->pitch, KEY_D, 0.0005f);
// 		KEYMACROAWW(b->pitch, KEY_C, -0.0005f);
// 
// 		KEYMACROAWW(b->yaw, KEY_F, 0.0005f);
// 		KEYMACROAWW(b->yaw, KEY_V, -0.0005f);
// 
// 		KEYMACROAWW(b->theta, KEY_G, 0.0005f);
// 		KEYMACROAWW(b->theta, KEY_B, -0.0005f);
// 
// 		KEYMACROAWW(b->phi, KEY_H, 0.0005f);
// 		KEYMACROAWW(b->phi, KEY_N, -0.0005f);
// 
// 		KEYMACROAWW(b->chi, KEY_J, 0.0005f);
// 		KEYMACROAWW(b->chi, KEY_M, -0.0005f);
