...
BOOL Application::Initiate()
{
	...
	scene.AddSceneObject(std::make_unique<PointLight>(window.Graphics, 0.5f, DirectX::XMFLOAT3{0.0f, 0.0f, 0.0f}));
	...
	scene.AddSceneObject(std::make_unique<Cube>(window.Graphics, 1.0f, "Models\\brickwall\\brick_wall_diffuse.jpg", "Models\\brickwall\\brick_wall_normal.jpg", DirectX::XMFLOAT3{ -6.0f, 0.0f, 0.0f }));
